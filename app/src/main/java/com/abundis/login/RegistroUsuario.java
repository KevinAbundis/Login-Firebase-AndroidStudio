...
public class RegistroUsuario extends AppCompatActivity implements View.OnClickListener {
    ...
    //Declaramos el objeto firebaseAuth para poder utilizar la autenticación de Firebase
    ...
    private void registrarUsuario(){
        //Obtener el nombre, email y contraseña
        ...
        if(TextUtils.isEmpty(name)){
            Toast.makeText(this, "Favor de ingresar su nombre", Toast.LENGTH_SHORT).show();
            return;
        }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            databaseReference.child("Usuarios").child(id).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task2) {
                                    if(task2.isSuccessful()){
                                        ...
                                        Toast.makeText(RegistroUsuario.this, "Se ha registrado el usuario correctamente", Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(RegistroUsuario.this, "No se pudieron registrar los datos correctamente", Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            if (task.getException() instanceof FirebaseAuthUserCollisionException) {
                                ...
                                Toast.makeText(RegistroUsuario.this, "Correo ya se encuentra registrado, intente con otro", Toast.LENGTH_SHORT).show();
                            } else {
